...
The bypass is intended only for local development and automated testing. Agents must not rely on this bypass when validating production authorization behavior.

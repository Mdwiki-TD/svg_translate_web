"""Unit tests for src/main_app/app_routes/profile.py."""
...
from src.main_app.app_routes.profile import bp_profile
...
def _mock_jobs_data_public(monkeypatch):
    monkeypatch.setattr(
        "src.main_app.app_routes.profile.jobs_data_public",
...
def _mock_stats_functions(monkeypatch):
    ...
    monkeypatch.setattr(
        "src.main_app.app_routes.profile.get_all_user_jobs_stats",
        mock_get_all,
    )
    monkeypatch.setattr(
        "src.main_app.app_routes.profile.get_user_jobs_stats",
        mock_get_user,
    )
...
class TestDashboard:
    def test_dashboard_without_username_and_logged_in(
        ...
        monkeypatch.setattr(
            "src.main_app.app_routes.profile.load_user",

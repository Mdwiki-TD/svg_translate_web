"""Unit tests for src/main_app/app_routes/api_routes.py module."""
...
class TestChartsTemplates:
    ...
    def test_charts_templates(self, mock_client: FlaskClient, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "src.main_app.app_routes.api_routes.list_owid_charts_templates",
            lambda: [ct1, ct2, ct3],
        )
...
class TestOwidChartsList:
    ...
    def _setup_mocks(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "src.main_app.app_routes.api_routes.list_charts",
            lambda: self.charts,
        )
        monkeypatch.setattr(
            "src.main_app.app_routes.api_routes.list_owid_charts_templates",

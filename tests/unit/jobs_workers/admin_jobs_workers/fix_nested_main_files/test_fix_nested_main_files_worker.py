...
def test_repair_nested_svg_tags_success(mock_fix_nested_services, tmp_path):
    ...
    result = worker.FixNestedMainFilesWorker.repair_nested_svg_tags(filename, user, tmp_path)
...
def test_repair_nested_svg_tags_no_tags(mock_fix_nested_services, tmp_path):
    ...
    result = worker.FixNestedMainFilesWorker.repair_nested_svg_tags("Clean.svg", {}, tmp_path)

...
def mock_upload(monkeypatch):
    _mock = MagicMock()
    monkeypatch.setattr("src.main_app.jobs_workers.admin_jobs_workers.crop_main_files.steps.upload.UploadFile.upload", _mock)
    return _mock

class TestUploadCroppedFile:
    """Unit tests for upload_cropped_file function."""
    def test_upload_cropped_file_success(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_no_site(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_exception_during_upload(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_strips_file_prefix(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_without_file_prefix(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_with_special_characters(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_uses_new_file_flag(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_uses_correct_summary(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_returns_filename_in_result(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_with_very_long_filename(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_upload_result_missing_keys(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_with_unicode_filename(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_passes_correct_site(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_with_path_object(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_empty_filename(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_with_wikitext(self, mock_upload, tmp_path):
    ...
    def test_upload_cropped_file_upload_fails(self, mock_upload, tmp_path):

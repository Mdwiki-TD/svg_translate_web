...
from src.main_app.public_jobs.workers.copy_svg_langs.steps.inject import inject_step


@patch("src.main_app.public_jobs.workers.copy_svg_langs.steps.inject.start_injects")

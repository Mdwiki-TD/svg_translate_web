...
from src.main_app.public_jobs.workers.copy_svg_langs.steps.fix_nested import fix_nested_step


@patch("src.main_app.public_jobs.workers.copy_svg_langs.steps.fix_nested.match_nested_tags")
@patch("src.main_app.public_jobs.workers.copy_svg_langs.steps.fix_nested.fix_nested_file")

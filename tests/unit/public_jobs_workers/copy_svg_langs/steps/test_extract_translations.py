...
from src.main_app.public_jobs.workers.copy_svg_langs.steps.extract_translations import extract_translations_step
...
def test_translations_task_stops_on_failure(monkeypatch, tmp_path, extract_return, expected_message):
    ...
    monkeypatch.setattr(
        "src.main_app.public_jobs.workers.copy_svg_langs.steps.extract_translations.download_one_file",
        fake_download_one_file,
    )
    monkeypatch.setattr(
        "src.main_app.public_jobs.workers.copy_svg_langs.steps.extract_translations.extract", fake_extract
    )

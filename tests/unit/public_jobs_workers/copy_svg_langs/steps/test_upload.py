...
from src.main_app.public_jobs.workers.copy_svg_langs.steps.upload import upload_step
...
@patch("src.main_app.public_jobs.workers.copy_svg_langs.steps.upload.upload_file")

...
class TestDownloadStep:
    @patch("src.main_app.public_jobs.workers.fix_nested_jobs.worker.download_svg_file")
...
class TestAnalyzeStep:
    ...
    @patch("src.main_app.public_jobs.workers.fix_nested_jobs.worker.detect_nested_tags")
...
class TestFixStep:
    ...
    @patch("src.main_app.public_jobs.workers.fix_nested_jobs.worker.fix_nested_tags")
...
class TestRun:
    def _patch_all(self, tmp_path):
        ...
        patches = {
            ...
            "get_site": patch(
                "src.main_app.public_jobs.workers.fix_nested_jobs.worker.get_user_site",
                return_value=MagicMock(),
            ),
            "download": patch(
                "src.main_app.public_jobs.workers.fix_nested_jobs.worker.download_svg_file",
                return_value={"ok": True, "path": svg},
            ),
            "detect": patch(
                "src.main_app.public_jobs.workers.fix_nested_jobs.worker.detect_nested_tags",
                return_value={"count": 2, "tags": ["g", "g"]},
            ),
            "fix": patch(
                "src.main_app.public_jobs.workers.fix_nested_jobs.worker.fix_nested_tags",
                return_value=True,
            ),
            "verify": patch(
                "src.main_app.public_jobs.workers.fix_nested_jobs.worker.verify_fix",
                return_value={"after": 0, "fixed": 2},
            ),
            "upload": patch(
                "src.main_app.public_jobs.workers.fix_nested_jobs.worker.upload_fixed_svg",

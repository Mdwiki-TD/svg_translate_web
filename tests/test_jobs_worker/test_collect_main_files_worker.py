...
from src.app import collect_main_files_worker
...
def mock_services(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("src.app.collect_main_files_worker.template_service.list_templates", mock_list_templates)
    monkeypatch.setattr("src.app.collect_main_files_worker.template_service.update_template", mock_update_template)
    ...
    monkeypatch.setattr("src.app.collect_main_files_worker.jobs_service.update_job_status", mock_update_job_status)
    monkeypatch.setattr("src.app.collect_main_files_worker.jobs_service.save_job_result_by_name", mock_save_job_result)
    monkeypatch.setattr("src.app.collect_main_files_worker.jobs_service.generate_result_file_name", mock_generate_result_file_name)

    # Mock get_wikitext
    mock_get_wikitext = MagicMock()
    monkeypatch.setattr("src.app.collect_main_files_worker.get_wikitext", mock_get_wikitext)

    # Mock find_main_title
    mock_find_main_title = MagicMock()
    monkeypatch.setattr("src.app.collect_main_files_worker.find_main_title", mock_find_main_title)

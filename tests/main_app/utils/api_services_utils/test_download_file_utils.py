...
from src.main_app.utils.api_services_utils.download_file_utils import download_commons_svgs
...
class TestDownloadCommonsSvgs:
    ...
    @patch("src.main_app.utils.api_services_utils.download_file_utils.download_commons_file_core")

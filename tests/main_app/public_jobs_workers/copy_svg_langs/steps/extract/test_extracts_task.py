...
def test_translations_task_stops_on_failure(monkeypatch, tmp_path, extract_return, expected_message):
    ...
    monkeypatch.setattr(
        "src.main_app.public_jobs_workers.copy_svg_langs.steps.extract.extract_task.download_one_file",
    ...
    translations, updated_stages = extract_translations.extract_translations_step(

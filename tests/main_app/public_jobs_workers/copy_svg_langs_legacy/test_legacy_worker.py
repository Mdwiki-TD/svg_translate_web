...
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.settings")
...
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.TaskStorePyMysql")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker._compute_output_dir")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.extract_text_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.extract_titles_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.extract_translations_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.download_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.fix_nested_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.inject_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.upload_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.save_files_stats")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.worker.make_results_summary")

...
from src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker import (
    _compute_output_dir,
    fail_task,
    make_stages,
    run_task,
...
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.settings")
...
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.TaskStorePyMysql")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker._compute_output_dir")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.extract_text_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.extract_titles_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.extract_translations_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.download_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.fix_nested_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.inject_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.upload_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.save_files_stats")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_worker.make_results_summary")

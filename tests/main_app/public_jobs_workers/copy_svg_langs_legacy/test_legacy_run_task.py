...
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.settings")
...
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.TaskStorePyMysql")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task._compute_output_dir")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.extract_text_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.extract_titles_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.extract_translations_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.download_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.fix_nested_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.inject_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.upload_step")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.save_files_stats")
@patch("src.main_app.public_jobs_workers.copy_svg_langs_legacy.legacy_run_task.make_results_summary")

...
from src.main_app.jobs_workers.copy_svg_langs import legacy_run_task
from src.main_app.jobs_workers.copy_svg_langs.legacy_threads import (
    get_cancel_event,
    launch_task_thread,
)
...
def test_launch_thread_registers_and_cleans_cancel_event(monkeypatch):
    ...
    monkeypatch.setattr("src.main_app.jobs_workers.copy_svg_langs.legacy_threads.run_task", fake_run_task)

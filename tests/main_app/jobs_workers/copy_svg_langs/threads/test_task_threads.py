...
from src.main_app.jobs_workers.copy_svg_langs.threads import web_run_task
from src.main_app.jobs_workers.copy_svg_langs.threads.task_threads import (
    get_cancel_event,
    launch_task_thread,
)
...
def test_launch_thread_registers_and_cleans_cancel_event(monkeypatch):
    ...
    monkeypatch.setattr("src.main_app.jobs_workers.copy_svg_langs.threads.task_threads.run_task", fake_run_task)

...
class TestDownloadMainFilesRoutes:
    ...
    def test_serve_download_main_file(self, mock_settings, mock_send, admin_jobs_client, tmp_path):
    ...
    def test_download_all_main_files(self, mock_create_zip, admin_jobs_client):
    ...
    @patch("src.main_app.public.jobs_utils_bp.create_main_files_zip")
    def test_download_all_main_files_no_zip(self, mock_create_zip, admin_jobs_client, monkeypatch):
    ...
    @patch("src.main_app.public.jobs_utils_bp.create_main_files_zip")
    def test_download_all_main_files_error(self, mock_create_zip, admin_jobs_client, monkeypatch):

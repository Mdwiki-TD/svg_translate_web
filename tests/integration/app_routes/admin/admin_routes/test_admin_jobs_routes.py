...
def test_delete_collect_templates_data_job(admin_jobs_client, jobs_db, monkeypatch):
    ...
    # Delete the job
    with patch("src.main_app.jobs_workers.jobs_worker.cancel_job_worker", return_value=False):
...
def test_cancel_collect_templates_data_job(admin_jobs_client, jobs_db, monkeypatch):
    ...
    # Cancel the job
    with patch("src.main_app.jobs_workers.jobs_worker.cancel_job_worker", return_value=True):

...
# Optional: Use replica.my.cnf file instead
# DB_CONNECT_FILE=/path/to/replica.my.cnf
```
...
USER_AGENT="Copy SVG Translations/1.0 (https://copy-svg-langs.toolforge.org; your-email@example.org)"

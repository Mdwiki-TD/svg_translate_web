...
def _list_published_charts() -> list[OwidChartRecord]:
    """
...
def _get_chart_by_id(chart_id: int) -> OwidChartRecord | None:
    """
...
def _get_chart_by_slug(slug: str) -> OwidChartRecord | None:
    """
...
@db_guard_rollback
def _update_chart_data_rollback(
    chart_id: int,
    chart_data: dict[str, Any],
) -> OwidChartRecord | None:
    """
...
def _update_chart_data_with_retry(
    chart_id: int,
    chart_data: dict[str, Any],
) -> OwidChartRecord | None:
    return _update_chart_data(chart_id, chart_data)
...
class OwidChartsService(CRUDService[OwidChartRecord]):
    ...
    def update_chart_data(
        ...
        return _update_chart_data_rollback(chart_id, chart_data)

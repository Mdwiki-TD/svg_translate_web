"""Worker for copying SVG languages (translations)."""
...
def copy_svg_langs_worker_entry(
    ...
    **kwargs: Any,
    ...
    worker = CopySvgLangsWorker(job_id, title, args, user, cancel_event)
    worker.run()
